            ...
            <div class = "col-6">
                <form action="warehouse_tables.php" method="get">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name ='product_name'  placeholder="Philips Monitor 24 inch">
                    ...
                    <button type="submit" name='added-product' class="btn btn-primary">Add Product</button>
                </form>
            </div>
